...
df = pd.read_csv(source + '/Data/novresults_demographics.csv')
df = df.drop(columns=['Unnamed: 0'])
columns = list(df.columns)
selected = columns[-30:-10]
selected.append(columns[2])
'''for i in [-8,-7,-6]:
...
df2.to_csv(source+'/Models/results_bidenvoteshare.csv')
